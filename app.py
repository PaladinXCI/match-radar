...
@st.cache_data(ttl=3600, show_spinner=False)
def get_recent_matches(team_id: int) -> list[dict[str, Any]]:
    payload = api_get(
    ...
    for league_name in selected_leagues:
        ...
        try:
            ...
            for match in matches:
                ...
                home_form = form_points(get_recent_matches(home["id"]), home["id"])
                away_form = form_points(get_recent_matches(away["id"]), away["id"])
